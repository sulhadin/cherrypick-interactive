...
✔ Select commits to cherry-pick (8 missing):
  ✔ #86c6105k9 - Add missing ATS configs in plists. (#1077)
  ✔ chore(deps): bump actions/checkout from 3 to 6 (#1079)
  ✔ #86c6q8y5r - Separete Corporate and Individual Registration (#1081)
  ✔ #86c5wbbuc - Refactor splash related store initializations (#1082)
  ✔ #86c6x2u20 - Remove deprecated reward center components (#1085)
  ✔ #0 - Upgrade ruby version in workflows. (#1087)

↷ Semver ignored (pattern: /bump/i): (chore(deps): bump actions/checkout from 3 to 6 (#1079))
↷ Semver ignored (pattern: /bump/i): (#86c5wbbuc - Refactor splash related store initializations (#1082))

Semantic Versioning
  Current: 4.36.0  Detected bump: minor  Next: 4.37.0

Creating release/4.37.0 from origin/main...
✓ Ready on release/4.37.0. Cherry-picking will apply here.

Cherry-picking 6 commit(s) onto main (oldest → newest)...

✓ cherry-picked (7ba30af) #86c6105k9 - Add missing ATS configs in plists. (#1077)
✓ cherry-picked (bbc70ed) chore(deps): bump actions/checkout from 3 to 6 (#1079)
✓ cherry-picked (287dbad) #86c6q8y5r - Separete Corporate and Individual Registration (#1081)

✖ Cherry-pick has conflicts on 8eb07cb78148866d769684730d154e5cbeb2f331 (8eb07cb).
Conflicted files:
  - android/app/build.gradle
  - ios/bilira_wallet.xcodeproj/project.pbxproj

✔ Choose how to proceed: Resolve conflicts now
✔ Select a file to resolve or a global action: Use theirs for ALL

No conflicted files reported by git.
✓ cherry-picked (8eb07cb) #86c5wbbuc - Refactor splash related store initializations (#1082)
✓ cherry-picked (3ae27ee) #86c6x2u20 - Remove deprecated reward center components (#1085)
✓ cherry-picked (66d0419) #0 - Upgrade ruby version in workflows. (#1087)

Summary → applied: 6, skipped: 0

Updating package.json version → 4.37.0 ...
✓ package.json updated and committed: chore(release): bump version to 4.37.0
✅ Pull request created for release/4.37.0 → main
```
